...
const QUOTES = [
  ...
  { text: '爱就是在一起吃很多很多顿饭', source: '—— 网络佚名' },
  { text: '没了烟火气，人生就是一段孤独的旅程', source: '—— 《人生一串》' },
  { text: '好吃的，就是好生活', source: '—— 蔡澜' },
  { text: '不求深刻，只求吃饱', source: '—— 网络佚名' },
  { text: '幸福就是甜品的味道', source: '—— 《西洋骨董洋果子店》' },
  { text: '厨房是世界上最治愈的地方', source: '—— 网络佚名' },
  { text: '有酒有肉有朋友，人生足矣', source: '—— 网络佚名' },
  ...
  { text: '旅行的意义不在于到达，而在于出发', source: '—— 网络佚名' },
  { text: '一个人的行走范围，就是他的世界', source: '—— 北岛' },
  { text: '远方的远方，比远方更远', source: '—— 海子' },
  { text: '趁着年轻，多去看看这个世界', source: '—— 网络佚名' },
  { text: '在山野间追风，看黄昏与黎明', source: '—— 网络佚名' },
  ...
  { text: '我们热爱生活，并非我们习惯生活，而是习惯热爱', source: '—— 网络佚名' },
  { text: '生活的理想，就是为了理想的生活', source: '—— 张闻天' },
  { text: '所谓生活，一半惊喜一半遗憾', source: '—— 网络佚名' },
  { text: '今天也是被生活治愈的一天', source: '—— 网络佚名' },
