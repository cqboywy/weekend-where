...
// Inactive: #ADB5BD = 173,181,189; Active: #FF6B35 = 255,107,53
const INACTIVE = [173, 181, 189];
const ACTIVE = [255, 107, 53];
...
// Also regenerate default-cover and marker-food with new colors
const cover = createPixels(750, 500);
fillRect(cover, 750, 0, 0, 750, 500, 248, 249, 250);
...
fillCircle(marker, 36, 18, 12, 10, 255, 107, 53);
fillRect(marker, 36, 14, 18, 8, 14, 255, 107, 53);
fillRect(marker, 36, 16, 28, 4, 5, 255, 107, 53);
fillRect(marker, 36, 17, 32, 2, 4, 255, 107, 53);
...
console.log('All v2 icons generated!');
