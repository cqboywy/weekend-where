...
// INACTIVE: #B5AEA5 = 181,174,165; ACTIVE: #8C9A84 = 140,154,132
const INACTIVE = [181, 174, 165];
const ACTIVE = [140, 154, 132];
...
// default-cover with rice paper color
const cover = createPixels(750, 500);
fillRect(cover, 750, 0, 0, 750, 500, 220, 207, 194);
fs.writeFileSync(path.join(imagesDir, 'default-cover.png'), buildPNG(750, 500, cover));
console.log('Created: default-cover.png');

// marker-food with sage green
const marker = createPixels(36, 36);
fillCircle(marker, 36, 18, 12, 10, 140, 154, 132);
fillRect(marker, 36, 14, 18, 8, 14, 140, 154, 132);
fillRect(marker, 36, 16, 28, 4, 5, 140, 154, 132);
fillRect(marker, 36, 17, 32, 2, 4, 140, 154, 132);
...
console.log('All v4 botanical icons generated!');
